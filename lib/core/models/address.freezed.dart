...
class _$AddressImpl extends _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, userId: $userId, label: $label, detail: $detail, district: $district, reference: $reference, latitude: $latitude, longitude: $longitude, isDefault: $isDefault, createdAt: $createdAt)';
  }
